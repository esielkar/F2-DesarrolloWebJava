...
import org.bedu.java.backend.sesion6.model.UsuarioDos;
...
@RestController
@RequestMapping("/api/v1/usuarioDos")
public class UsuarioDosController {

    @PostMapping
    public ResponseEntity<UsuarioDos> creaUsuario(@RequestBody UsuarioDos usuario){
